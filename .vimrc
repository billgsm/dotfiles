...
echo "????????????????????????????????"
echo "I'll begin with 2dd to delete two lines, then dst to delete the surrounding HTML tag."
echo "dd again to delete line. dat to delete this head tag and dst to delete this body tag."
