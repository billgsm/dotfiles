...
# z.sh
# Does not work perfectly but it looks very helpful
# https://github.com/rupa/z
# Try later maybe it's a great tool!
# . bash_scripts/z.sh
...
#
# neovim wants this when using tmux
...
# timer plugin (oh my zsh)
export TIMER_PRECISION=4
